...
if __name__ == "__main__":
    ...
    if args.encrypt:
        ...
        create_encrypted_index(generator.index, Path(args.encrypt), Path(args.public_key), Path(args.vm_file) if args.vm_file else None, unhexlify(args.drm_key) if args.drm_key else None)
